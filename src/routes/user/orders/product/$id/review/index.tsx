...
export const Route = createFileRoute('/user/orders/product/$id/review/')({
  component: RouteComponent,
})

function RouteComponent() {
  const productId = useParams({
    from: '/user/orders/product/$id/review/',
    select: (p) => p.id,
  })
    ...
    <>
      ...
      <div className="my-12">
        ...
        <label htmlFor="productReview" className="block">
          ...
          <textarea id="productReview" className="textarea w-full"></textarea>
        </label>
      </div>
      ...
      <div className="mt-12">
        ...
        <label htmlFor="logisticsReview" className="block">
          ...
          <textarea id="logisticsReview" className="textarea w-full"></textarea>
        </label>
      </div>
